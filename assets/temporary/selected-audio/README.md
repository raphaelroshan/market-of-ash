# Selected temporary audio

These files are byte-identical `.oggstr` export copies of selected CC0 Kenney assets. The extension allows deterministic runtime decoding from a clean source checkout and from an exported Godot package without relying on editor-generated import metadata.

| Runtime file | Original source | SHA-256 |
|---|---|---|
| `command-success.oggstr` | `../kenney/interface-sounds/Audio/confirmation_001.ogg` | `063564703b6094d70718a3e787a55cc9141611e4ecd6b6637f8828f79b4a8c3a` |
