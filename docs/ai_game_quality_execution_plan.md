...
**Applies to:** `v0.13.7-alpha-basin-vertical-slice` and later
...
> **Current audit:** `0.13.7-alpha-basin-vertical-slice` passes the automated vertical-slice scope. The opening shell uses an explicit stacked composition at 1280 pixels and below, while 1600×900 and larger retain the split composition. Licensed temporary confirmation, error, and caravan-creak cues replace synthetic beeps without carrying essential information. The committed road now opens with a short palette-tinted dust accent that is suppressed by Reduce Travel Motion and fades before the mandatory road stop. Current native evidence verifies the complete scripted journey and all required opening controls at 960×540, 1280×720, 1600×900, and 1920×1080. The broader game-quality roadmap remains open for commercial art polish, physical-device and assistive-technology coverage, antivirus/storefront hardening, and moderated player evidence. Do not describe those external gates as complete.
