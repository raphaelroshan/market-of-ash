...
The active sequence is **MA-I1 Shell/performance**, **MA-I2 Trade fantasy**, **MA-I3 Creative vertical**, **MA-I4 Region two**, **MA-I5 Region three and basin memory**, and **MA-I6 Early Access hardening**. MA-I1 and MA-I2 are complete with evidence in [`ma_i1_completion.md`](ma_i1_completion.md) and [`ma_i2_completion.md`](ma_i2_completion.md); MA-I3 is active. Human testing may calibrate the build later but is not a prerequisite for these gates.
