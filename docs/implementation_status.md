...
- The current head cross-exports locally as a 64-bit Windows PE with a structurally verified embedded PCK using compatible x86-64 templates. Windows file/product versions use the numeric `0.15.0.0` required by PE resources while the player-facing project version is `0.15.0-early-access-rc2`.
