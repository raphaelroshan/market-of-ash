...
3. **Early Access release hardening is still incomplete.** The project now meets the floor for regions (3), settlements (10), goods (10), routes (7), crew (5), event families (8), standing factions (4), replacement actors (2), and endings (6). MA-EA-6 remains required before an Early Access claim.
