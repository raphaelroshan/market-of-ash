...
- Reduced-motion and 25% large-text options persist in a separate user settings file without entering deterministic campaign state. Long Shop/Departure context scrolls while Buy, Sell, the guided purchase, and Plan departure remain pinned and asserted within the layout as text reflows; packaged-browser evidence covers the 960×540 baseline.
