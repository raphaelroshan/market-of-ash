...
- Reduced-motion and 25% large-text options persist in a separate user settings file without entering deterministic campaign state. The UI smoke path runs at the 960×540 minimum viewport; long Shop/Departure context scrolls while Buy, Sell, the guided purchase, and Plan departure remain pinned and asserted visible as text reflows.
