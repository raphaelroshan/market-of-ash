...
- Reset requires explicit confirmation, does not overwrite the disk save itself, and explains that the previous campaign remains loadable until the next successful autosave.
