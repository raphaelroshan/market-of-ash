...
- When a validated campaign exists, Start Game requires a cancel-focused confirmation and states exactly when the new run would replace that disk save; first launch remains immediate.
