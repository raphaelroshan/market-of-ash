...
**Completed milestones:** `0.13.0-alpha-basin-vertical-slice` deterministic vertical-slice scope; MA-EA-1 responsive Basin completion; MA-EA-2 Glasswind Reach trade slice; MA-EA-3 Siltfire March connected-map trade slice; MA-EA-4 fourth-faction and adaptive-ending validation
**Next target:** MA-EA-5 crew depth, event variety, and Early Access breadth completion
...
>
> **Status clarification (updated 2026-09-02):** The deterministic Five-Well Basin vertical slice and MA-EA-1 through MA-EA-4 are complete and verified. The project now meets the breadth floors for regions, settlements, goods, routes, standing factions, replacement actors, and endings, but is **not** complete as an Early Access game: MA-EA-5 and MA-EA-6 still provide crew/event breadth and release hardening. The earlier 1280×720 clipping claim reused the same cropped Xvfb frames under two version labels and is superseded by native and packaged-browser bounds evidence.
