...
1. CI run 200 completed the cross-engine packaged Web matrix: 84 inspected captures cover 14 normal/Large text/event/result states at exact 960×540 and 1280×720 viewports in Chrome, Firefox, and Edge, require matching app/ARIA state, and use decoded pixels to reject superficial transitions. A local real-renderer matrix adds 42 inspected macOS/OpenGL frames across 960×540, 1280×720, and 1920×1080 at Retina display scale 2.0; CI run 205 adds 14 inspected Windows/ANGLE frames at 960×540. Remaining visual gates are Windows 125%, 150%, and 200% OS scaling plus hands-on browser keyboard/shortcut and assistive-technology review.
...
4. CI structurally validates and headlessly launches the packaged x86-64 Windows PE, and run 205 rendered and validated the full 14-state minimum-window UI journey through Windows ANGLE. Packaged GUI launch on a clean Windows machine, installer/distribution behavior, visible resource-metadata inspection, and the documented OS-scaling matrix remain manual Windows gates.
