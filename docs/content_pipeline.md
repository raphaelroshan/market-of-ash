...
| `content/economy_framework.json` | Frontier-style price divergence, market trends, demand, market memory, distance bands, route profitability, and trade decisions. |
| `content/settlement_actions.json` | Settlement visits, trade, contracts, recruitment, guards, information, logistics, diplomacy, relief, and interface rules. |
...
| `tools/validate_economy_and_settlements.py` | Validator for Frontier economy pillars, market coverage, settlement actions, service slots, and interface safeguards. |
