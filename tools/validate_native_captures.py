...
REQUIRED_LAYOUT_CONTROLS = {
    ...
    "departure_desk": ("JourneyMapPanel", "DeparturePanel", "JourneyPhaseTitle", "DepartureControlsScroll", "DeparturePrimaryAction", "JourneyResultScroll"),
    ...
    "investment_departure": ("JourneyMapPanel", "DeparturePanel", "JourneyPhaseTitle", "JourneyResultScroll"),
    "investment_road": ("JourneyMapPanel", "DeparturePanel", "JourneyPhaseTitle", "RoadPrimaryAction", "JourneyResultScroll"),
    "investment_event": ("JourneyMapPanel", "DeparturePanel", "JourneyPhaseTitle", "DepartureControlsScroll", "JourneyResultScroll"),
    "investment_arrival": ("JourneyMapPanel", "DeparturePanel", "JourneyPhaseTitle", "DepartureControlsScroll", "ArrivalPrimaryAction", "JourneyResultScroll", "JourneyConsequenceReceipt"),
