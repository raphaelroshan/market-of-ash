...
REQUIRED_SETTLEMENTS = ("ashgate", "brine_cross", "cinderford", "hollow_market", "reedwatch", "sunfall_exchange", "kiln_rest", "mirror_wells", "mothlight_quay", "blackreed_post", "emberfen_refuge")
REQUIRED_ROUTES = ("old_road", "toll_road", "dry_cut", "glasswind_trace", "mirror_run", "emberglass_byway", "salt_causeway", "reedline_track", "emberfen_drift")
...
def validate(data: Any) -> list[str]:
    ...
    for settlement_id in REQUIRED_SETTLEMENTS:
        ...
        if identity.get("landmark") not in {"gate", "brine", "forge", "lanterns", "reeds", "glass", "kiln", "mirrors", "quay", "watchtower", "peat_stacks"}:
