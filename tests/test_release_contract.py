...
def main() -> int:
    ...
    assert details == {
        "game_version": "0.16.1-early-access-rc1",
        "windows_version": "0.16.1.0",
        "content_version": "1.28.0",
        "release_notes": "docs/releases/v0.16.1-early-access-rc1.md",
    }

    with tempfile.TemporaryDirectory() as temporary_directory:
        fixture = Path(temporary_directory)
        manifest_path = fixture / "release_manifest.json"
        manifest = create_manifest(ROOT, manifest_path, "abc123", "refs/tags/v0.16.1-early-access-rc1", "42", "7")
        assert manifest["game_version"] == "0.16.1-early-access-rc1"
    ...
    with tempfile.TemporaryDirectory() as temporary_directory:
        ...
        for relative in (
            ...
            "docs/releases/v0.16.1-early-access-rc1.md",
