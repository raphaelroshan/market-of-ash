...
func _initialize() -> void:
	...
	_expect(ui.shop_good_option.find_prev_valid_focus() == ui.bazaar_navigation_buttons[4] and ui.plan_departure_button.find_next_valid_focus() == ui.bazaar_navigation_buttons[0], "Shop focus should include the Bazaar directory and wrap from the pinned Plan action to its first stall")
	...
	_expect(ui.active_bazaar_section == "trade" and not ui.bazaar_scene.visible and ui.shop_market_scroll.visible and ui.shop_purchase_row.visible, "the Bazaar should open on its primary Trade work surface without unrelated illustrated-stall content")
	...
	_expect(not ui.campaign_outlook_label.visible and not ui.bazaar_scene.visible and ui.shop_market_scroll.visible and ui.shop_purchase_row.visible and ui.get_viewport().gui_get_focus_owner() == ui.shop_good_option, "closing Outlook and returning to Trade should restore only the focused market flow")
