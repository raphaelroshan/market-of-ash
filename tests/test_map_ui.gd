...
func _initialize() -> void:
	...
	_expect(menu_accessibility_controls.is_empty(), "Web accessibility controls should not invent planning fields on the Main Menu")
