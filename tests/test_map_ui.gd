...
func _initialize() -> void:
	...
	ui.world.money = 120
	ui._refresh_ui()
	_expect(ui.diagnostics_label.text.contains("build development") and ui.diagnostics_label.text.contains("seed 1107") and ui.diagnostics_label.text.contains("save v12") and ui.diagnostics_label.text.contains("content 1.26.0"), "shop diagnostics should expose reproducible build/seed/save/content versions")
	...
	_expect(int(report.get("report_version", 0)) == 6 and report.get("game_version", "") == "0.14.0-early-access-rc1" and report.get("build_commit", "") == "development" and int(report.get("seed", 0)) == 1107 and report.get("command_history", []).size() == 2, "playtest report should include schema, build, seed, and command evidence")
