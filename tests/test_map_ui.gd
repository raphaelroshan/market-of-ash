...
func _initialize() -> void:
	...
	_expect(ui.diagnostics_label.text.contains("seed 1107") and ui.diagnostics_label.text.contains("save v11") and ui.diagnostics_label.text.contains("content 1.11.0"), "shop diagnostics should expose reproducible seed/save/content versions")
