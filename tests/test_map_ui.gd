...
func _initialize() -> void:
	...
	_expect(ui.event_choice_buttons[0].text.contains("PAY / CERTAIN") and ui.event_choice_buttons[0].text.contains("IF CHOSEN") and ui.event_choice_buttons[1].text.contains("MANEUVER / RISK ROLL 25%"), "event choices should distinguish tactical posture, certainty, and expected consequence before commitment")
	...
	_expect(ui.event_choice_buttons[0].text.contains("COST — 2 repair materials") and ui.event_choice_buttons[0].text.contains("RECEIVE — 30 ashmarks"), "premium option did not separate its cargo cost from its exact reward")
