...
func _initialize() -> void:
	...
	_expect(menu_web_state.get("accessibility_controls_first") == false, "Web accessibility controls should follow Start and Continue on the Main Menu")
	...
	_expect(initial_web_state.get("accessibility_controls_first") == true, "Shop semantic planning fields should precede its actions")
